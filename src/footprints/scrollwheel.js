...
module.exports = {
  ...
  body: p => {
    const standard = `
      ...
      (fp_text reference "${p.ref}" (at 0 0 ${p.r}) (layer F.Fab) (effects (font (size 1 1) (thickness 0.15))))
      (fp_text value "" (at -0.1 9 ${p.r}) (layer F.Fab) (effects (font (size 1 1) (thickness 0.15))))
